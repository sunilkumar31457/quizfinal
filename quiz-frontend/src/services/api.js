...
// Backend API base URL: use env variable if available (VITE_API_BASE_URL), else default to a relative path
// This allows the app to work both in dev (vite proxy) and production (nginx proxy)
